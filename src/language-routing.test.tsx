...
describe('GitHub Pages redirect detection', () => {
    const isPathRedirect = (search: string) => search.length > 0 && !search.slice(1).includes('=');
...
describe('LangRoute', () => {
    ...
    it('sets canonical link for Dutch route', async () => {
        ...
        await waitFor(() => {
            expect(document.querySelector('link[rel="canonical"]')?.getAttribute('href')).toBe(
                'https://velizartodorov.github.io/nl/',
            );
        });
    });
    ...
    it('sets hreflang alternate links', async () => {
        ...
        await waitFor(() => {
            ...
            expect(document.querySelector('link[hreflang="nl"]')?.getAttribute('href')).toBe(
                'https://velizartodorov.github.io/nl/',
            );
