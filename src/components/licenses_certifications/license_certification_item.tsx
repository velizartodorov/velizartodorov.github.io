    ...
    return (
        <li>
            <Tag
                ...
                className="hover:bg-app-surface-alt focus:bg-app-surface-alt block rounded-lg px-3 py-2 transition-colors hover:no-underline focus:no-underline"
            >
                <div className="flex items-center gap-3">
                    <div className="flex min-w-0 flex-1 items-center gap-3">
                        <div className="shrink-0 text-left">
                            <img
                                src={item.icon}
                                alt="license icon"
                                className="bg-app-icon-bg h-[25px] w-[30px] rounded shadow-[0_1px_4px_var(--app-shadow)]"
                            />
                        </div>
                    ...
                    <AccordionChevron
                        open={false}
                        className="text-app-text-muted invisible h-5 w-5"
                    />
                </div>
            </Tag>
        </li>
