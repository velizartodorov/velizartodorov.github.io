...
describe('section page metadata', () => {
    it('sets the canonical URL, hreflang alternates, and translated title for each section', async () => {
        ...
        for (const section of SECTIONS) {
            ...
            // a different position) rather than to themselves - see src/app/[section]/page.tsx.
