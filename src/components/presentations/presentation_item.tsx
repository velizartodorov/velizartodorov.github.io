    ...
    return (
        <li>
            <a
                ...
                className="hover:bg-app-surface-alt focus:bg-app-surface-alt text-app-link hover:text-app-link-hover block rounded-lg px-4 py-2 transition-colors hover:no-underline focus:no-underline"
            >
