...
describe('sectionPath', () => {
    ...
    it('returns the English section path', () => {
        expect(sectionPath('en', 'employments')).toBe('/employments/');
    });

    it('returns the Dutch section path', () => {
        expect(sectionPath('nl', 'employments')).toBe('/nl/employments/');
    });
});
...
describe('sectionFromPathname', () => {
    ...
    it('returns the slug for an English section path', () => {
        expect(sectionFromPathname('/employments/')).toBe('employments');
    });

    it('returns the slug for a Dutch section path', () => {
        expect(sectionFromPathname('/nl/employments/')).toBe('employments');
    });
