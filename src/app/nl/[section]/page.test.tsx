...
const { nl: NL_URL } = HREFLANG_ALTERNATES;
...
describe('section page metadata', () => {
    it('sets the Dutch canonical URL, hreflang alternates, site title, and section-specific OpenGraph title for each section', async () => {
        ...
        for (const section of SECTIONS) {
            ...
            // to a different position) rather than to themselves - see src/app/metadata.ts.
